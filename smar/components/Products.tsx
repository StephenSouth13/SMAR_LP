...
// 1. Import SKUSection từ types/cms
import { SKUSection, SKUItem } from "@/types/cms";
...
export const Products = () => {
  // 2. Ép kiểu Generic <SKUSection> để content có đầy đủ thuộc tính skus, title, combo...
  const { content, loading } = useContent<SKUSection>('sku');
  ...
  // 3. Sử dụng SKUItem thay vì any
  const activeSkus = (content?.skus || []).filter((sku: SKUItem) => !sku.isHidden);
    ...
    <section id="pricing" className="py-24 px-6 md:px-12 lg:px-20 bg-[#004282]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          {activeSkus.map((sku: SKUItem, index: number) => (
            <div
            ...
            >
              ...
              {/* Thay flex-grow bằng grow theo gợi ý Tailwind */}
